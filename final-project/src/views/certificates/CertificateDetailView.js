            ...
            <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
                <View style={styles.container}>
                    <View style={styles.header}>
                        ...
                        <Text style={styles.headerTitle}>Certificate Details</Text>
                        <View style={[styles.statusBadge, certificate.status === 'active' ? styles.activeStatus : styles.inactiveStatus]}>
                        ...
                        <View style={styles.card}>
                            ...
                            <View style={styles.infoCard}>
                                <View style={styles.infoRow}>
                                    <View style={styles.infoIcon}><Ionicons name="book" size={22} color="#4F46E5" /></View>
                                ...
                                <View style={styles.infoRow}>
                                    <View style={styles.infoIcon}><Ionicons name="information-circle" size={22} color="#10B981" /></View>
                                    <View style={styles.infoContent}>
                                ...
                                <View style={styles.infoRow}>
                                    <View style={styles.infoIcon}><Ionicons name="calendar" size={22} color="#F59E0B" /></View>
                                    <View style={styles.infoContent}>
                                ...
                                <View style={styles.infoRow}>
                                    <View style={styles.infoIcon}><Ionicons name="time" size={22} color="#EF4444" /></View>
                                    <View style={styles.infoContent}>
                                        <Text style={styles.infoLabel}>Validity Period</Text>
                                        <Text style={styles.infoValue}>{certificate.validityPeriod}</Text>
                                    </View>
                                </View>

                                <View style={styles.infoRow}>
                                    <View style={styles.infoIcon}><Ionicons name="color-palette" size={22} color="#8B5CF6" /></View>
                                    <View style={styles.infoContent}>
                                        <Text style={styles.infoLabel}>Template Design</Text>
                                        <Text style={styles.infoValue}>
                                            {certificate.templateDesign ? certificate.templateDesign.charAt(0).toUpperCase() + certificate.templateDesign.slice(1) : '—'}
                                        </Text>
                                    </View>
                                </View>
                            </View>
                            ...
                            <View style={styles.actions}>
                                <TouchableOpacity style={styles.editButton} onPress={() => onEdit(certificateId)}>
...
const styles = StyleSheet.create({
    ...
    card: { width: '100%', maxWidth: 720, backgroundColor: '#fff', borderRadius: 12, padding: 18, borderWidth: 1, borderColor: '#E8EAEE', elevation: 3 },
    ...
    infoRow: { flexDirection: 'row', paddingVertical: 14, borderBottomWidth: 1, borderBottomColor: '#F3F4F6', alignItems: 'center' },
    infoIcon: { width: 44, height: 44, borderRadius: 22, backgroundColor: '#F8FAFB', alignItems: 'center', justifyContent: 'center', marginRight: 12 },
    infoContent: { flex: 1 },
    infoLabel: { fontSize: 13, color: '#9CA3AF', fontWeight: '600' },
    infoValue: { fontSize: 15, color: '#111827', fontWeight: '600', marginTop: 6 },

    actions: { marginTop: 18, flexDirection: 'row', justifyContent: 'space-between' },
    editButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#4F46E5', paddingVertical: 12, paddingHorizontal: 16, borderRadius: 10 },
    editText: { color: '#fff', fontWeight: '700', marginLeft: 8 },
    deleteButton: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#EF4444', paddingVertical: 12, paddingHorizontal: 16, borderRadius: 10 },
    deleteText: { color: '#fff', fontWeight: '700', marginLeft: 8 },

    centerEmpty: { flex: 1, alignItems: 'center', justifyContent: 'center' },
    emptyText: { marginTop: 12, color: '#6B7280', fontSize: 16, fontWeight: '600' },
});
