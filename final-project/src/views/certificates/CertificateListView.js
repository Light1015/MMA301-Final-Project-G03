...
const CertificateListView = ({ onNavigateToForm, onNavigateToDetail, refreshToken = 0 }) => {
        ...
        <View style={styles.certificateCard}>
            ...
            <View style={styles.infoContainer}>
                ...
                <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoText}>Valid: {item.validityPeriod || '—'}</Text>
                </View>
            </View>
            ...
            <FlatList
                ...
                ListEmptyComponent={
                    <View style={styles.emptyContainer}>
                        ...
                        <Text style={styles.emptySubtext}>Create your first certificate to get started</Text>
                    </View>
                }
            />
        </SafeAreaView>
